...
class OrderController extends Controller
{
    ...
    public function updateLinks(Request $request, Course $course)
    {
        ...
        try {
            ...
            return redirect()->route('admin.batchs.index')->with('success', 'Links updated successfully.');
        } catch (\Exception $e) {
            Log::error('Failed to update links for course ' . $course->id . ': ' . $e->getMessage());
            return redirect()->route('admin.batchs.index')->with('warning', 'Failed to update links: ' . $e->getMessage());
        }
    }
    ...
    public function AllOrders()
    {
        ...
        return view('admin.orders.all_order', compact('purchases'));
    }
