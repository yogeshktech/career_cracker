    ...
    <div class="dashboard-body">
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            <div class="breadcrumb mb-24">
                <ul class="flex-align gap-4">
                    ...
                    <li><span class="text-main-600 fw-normal text-15">Edit Faculty Account</span></li>
                </ul>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="facultyForm" action="{{ route('admin.faculties.update', $faculty->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row gy-20">
                        <div class="col-xxl-3 col-md-4 col-sm-5">
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <div class="mt-3">
                                    <img id="imagePreview" src="{{ asset($faculty->profile_image) }}" alt="Preview" style="max-height: 200px; display: block;">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-20">
                                <div class="col-sm-12">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="text-counter placeholder-13 form-control py-11 pe-76"
                                            maxlength="100" id="name" name="name" placeholder="Enter Faculty Name" value="{{ old('name', $faculty->name) }}">
                                        <div class="text-gray-400 position-absolute inset-inline-end-0 top-50 translate-middle-y me-16">
                                            <span id="current">{{ strlen(old('name', $faculty->name)) }}</span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="email" class="form-control py-9 placeholder-13 text-15" id="email" name="email"
                                        placeholder="Enter Faculty Email" value="{{ old('email', $faculty->email) }}">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="position" name="position" class="form-select py-9 placeholder-13 text-15">
                                        ...
                                        <option value="Head of Department" {{ old('position', $faculty->position) == 'Head of Department' ? 'selected' : '' }}>Head of Department</option>
                                    </select>
                                    @error('position')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="experience" name="experience" class="form-select py-9 placeholder-13 text-15">
                                        ...
                                        <option value="1-3 Years" {{ old('experience', $faculty->experience) == '1-3 Years' ? 'selected' : '' }}>1-3 Years</option>
                                        <option value="3-5 Years" {{ old('experience', $faculty->experience) == '3-5 Years' ? 'selected' : '' }}>3-5 Years</option>
                                        <option value="5-10 Years" {{ old('experience', $faculty->experience) == '5-10 Years' ? 'selected' : '' }}>5-10 Years</option>
                                        <option value="10+ Years" {{ old('experience', $faculty->experience) == '10+ Years' ? 'selected' : '' }}>10+ Years</option>
                                    </select>
                                    @error('experience')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="specialization" name="specialization" class="form-select py-9 placeholder-13 text-15">
                                        ...
                                        <option value="Data Structures" {{ old('specialization', $faculty->specialization) == 'Data Structures' ? 'selected' : '' }}>Data Structures</option>
                                        <option value="Machine Learning" {{ old('specialization', $faculty->specialization) == 'Machine Learning' ? 'selected' : '' }}>Machine Learning</option>
                                        <option value="Economics" {{ old('specialization', $faculty->specialization) == 'Economics' ? 'selected' : '' }}>Economics</option>
                                        <option value="Psychology" {{ old('specialization', $faculty->specialization) == 'Psychology' ? 'selected' : '' }}>Psychology</option>
                                        <option value="Marketing" {{ old('specialization', $faculty->specialization) == 'Marketing' ? 'selected' : '' }}>Marketing</option>
                                        <option value="Finance" {{ old('specialization', $faculty->specialization) == 'Finance' ? 'selected' : '' }}>Finance</option>
                                    </select>
