    ...
    <div class="dashboard-body">
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            <div class="breadcrumb mb-24">
                <ul class="flex-align gap-4">
                    ...
                    <li><span class="text-main-600 fw-normal text-15">Create Language</span></li>
                </ul>
            </div>
            <div class="flex-align justify-content-end gap-8">
                <button type="submit" form="languageForm" class="btn btn-main rounded-pill py-9">Save Language</button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="languageForm" action="{{ route('admin.language.store') }}" method="POST">
                    @csrf
                    <div class="row g-20">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="status" name="status" class="form-select py-9 placeholder-13 text-15">
                                <option value="" disabled {{ old('status', $language->status ?? '') === null ? 'selected' : '' }}>Select Status</option>
