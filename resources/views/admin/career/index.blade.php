    ...
    <div class="dashboard-body">
        ...
        <div class="card overflow-hidden">
            <div class="card-body p-0 overflow-x-auto">
                <table id="careerTable" class="table table-striped">
                    <thead>
                        <tr>
                        ...
                        @forelse ($careers as $career)
                            <tr>
                                <td class="fixed-width">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="selected[]" value="{{ $career->id }}">
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <form action="{{ route('admin.career.destroy', $career->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
