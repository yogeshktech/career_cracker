    ...
    <div class="dashboard-body">
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            ...
            <div class="buttons flex-align gap-8">
                <a href="{{ route('admin.courses.create') }}" class="btn btn-main rounded-pill py-9">Add Course</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="card border border-gray-100">
                                        <div class="card-body p-8">
                                            ...
                                            <div class="p-8">
                                                ...
                                                <p><del>{{ $course->mrp }}</del></p>
                                                <p>{{ $course->sale_price }}</p>
                                                <div class="flex-align gap-8 mt-12">
                                                    <span
                                                        class="text-main-600 flex-shrink-0 text-13 fw-medium">{{ $course->progress }}%</span>
                                                    <div class="progress w-100 bg-main-100 rounded-pill h-8" role="progressbar"
                                                        aria-label="Progress" aria-valuenow="{{ $course->progress }}"
                                                ...
                                                {{-- <div class="flex-align gap-5 mt-24">
                                                    ...
                                                    <form action="{{ route('admin.courses.destroy', $course->id) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-outline-main rounded-pill py-9 w-100"
                                                            onclick="return confirm('Are you sure?')">Delete</button>
                                                    </form>
                                                </div> --}}
                                                <div class="flex-align gap-5 mt-24">
                                                    <a href="{{ route('admin.courses.edit', $course->id) }}"
                                                        class="btn btn-outline-main rounded-pill py-9 w-70">Edit</a>
