                            ...
                            <div class="row g-20">
                                ...
                                <div class="col-sm-6">
                                   ...
                                   <input type="text" name="duration" value="{{ old('duration', $course->duration) }}"
                                        class="form-control py-9 placeholder-13 text-15" placeholder="Duration" step="0.01" min="0" required>
                                    @error('duration')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="is_saleable" name="is_saleable" class="form-select py-9 placeholder-13 text-15">
                                        <option value="1" {{ $course->is_saleable == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $course->is_saleable == 0 ? 'selected' : '' }}>No</option>
                                    </select>
                                    @error('is_saleable')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
