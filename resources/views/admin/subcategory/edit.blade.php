        ...
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            <div class="breadcrumb mb-24">
                <ul class="flex-align gap-4">
                    ...
                    <li><span class="text-main-600 fw-normal text-15">Edit Subcategory</span></li>
                </ul>
            </div>
        </div>
                ...
                <form action="{{ route('admin.subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row gy-20">
                        <div class="col-xxl-3 col-md-4 col-sm-5">
                            ...
                            <div class="mb-20">
                                <label class="h5 fw-semibold font-heading mb-0">Thumbnail Image</label>
                            </div>
                            <div class="mb-3">
                                ...
                                {{-- Image preview --}}
                                <div class="mt-3">
                                    <img id="thumbnailPreview" src="{{ asset($subcategory->thumbnail) }}" alt="Preview" style="max-height: 200px; {{ $subcategory->thumbnail ? '' : 'display: none;' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-20">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control py-11 placeholder-13" id="title" name="title"
                                           placeholder="Enter subcategory title" value="{{ old('title', $subcategory->name) }}">
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="publicOption"
                                               value="public" {{ old('status', $subcategory->status) == 'public' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="privateOption"
                                               value="private" {{ old('status', $subcategory->status) == 'private' ? 'checked' : '' }}>
