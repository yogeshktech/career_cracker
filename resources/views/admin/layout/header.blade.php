                                    ...
                                    <div class="border-bottom border-gray-100 mb-24 pb-24">
                                        <div class="flex-align gap-4">
                                            <a href="#"
                                                ...
                                                Bose is
                                                requesting access to Design File - Final Project. </a>
                        ...
                        @if(Auth::guard('admin')->check())
                            <div class="card-body">
                                <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                                    ...
                                    @else
                                        <img src="{{ asset('admin/assets/images/thumbs/user-img.png') }}" alt="Profile"
                                            class="w-54 h-54 rounded-circle">
                                    @endif
                                    <div>
                                        <h4 class="mb-0">{{ Auth::guard('admin')->user()->name }}</h4>
                                        <p class="fw-medium text-13 text-gray-200">{{ Auth::guard('admin')->user()->email }}</p>
                                    </div>
                                </div>
