    ...
    <div class="row gy-4">
        ...
        <div class="col-md-6">
            <div class="career-form__input">
                ...
                <input type="text" name="subject" id="subject" placeholder="Enter the position you're applying for"
        ...
        <div class="col-12">
            <div class="career-form__input">
                ...
                <input type="file" name="resume" id="resume"
                       class="form-control @error('resume') is-invalid @enderror" accept=".pdf" required>
