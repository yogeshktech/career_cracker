                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="modal-form position-relative">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="password" class="form-control1" placeholder="Password" required pattern="^(?=.*[\W_]).{8,}$" title="Password must be at least 8 characters long and contain at least one special character.">
                                ...
                                <div class="col-md-6">
                                    <div class="modal-form position-relative">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="password_confirmation" class="form-control1" placeholder="Confirm Password" required pattern="^(?=.*[\W_]).{8,}$" title="Password must be at least 8 characters long and contain at least one special character.">
                                            <span class="password-toggle-icon"><i class="fas fa-eye"></i></span>
                                        </div>
